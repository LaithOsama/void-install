...
XBPS_ARCH=$ARCH xbps-install -S -r /mnt -R "$REPO" base-minimal linux4.19 bash openssh dhcpcd acpid neovim \
e2fsprogs ethtool iputils usbutils pciutils ncurses grub os-prober ntfs-3g
